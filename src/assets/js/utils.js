...
const getDateDiff = (date) => {
    ...
    let diffWeek = Number((diffValue / (7 * day)).toPrecision(1));
    let diffDay = Number((diffValue / day).toPrecision(1));
    let diffHour = Number((diffValue / hour).toPrecision(1));
    let diffMinute = Number((diffValue / minute).toPrecision(1));
