            ...
            <mt-tab-container-item v-for="(item,index) in navList" :id="String(index)" :key="index">
                <article class="wows fadeInUp article-list" v-if="navContainer.length">
                    <div class="wow fadeInUp article-content" v-for="(item,index) in navContainer" :key="index"
                         @click="_articleDetails(item,index)">
                        <figure>
...
<script lang="ts">
    ...
    export default class Classification extends Vue {
        ...
        static _getViewPortHeight(): number {
        ...
        _getTab() {
            ...
            this['tcb'].callFunction({
                ...
                .then((res) => {
                    ...
                    console.log(list);
                    if (list.length) {
                        this._getSwitchData('archive', list[0].name);
                        this.navList = list;
                    }
       ...
       * */
        ...
        getSelected(newVal, oldVal) {
            ...
            if (newVal) {
                ...
                this._getSwitchData('archive', this.navList[newVal].name);
            }
        }
